...
def streaming_chatbot() -> None:
    ...
    while True:
        ...
        history.append({"role": "assistant", "content": "".join(assistant_reply_parts)})
        history = history[-6:]
...
# Give unittest.mock.patch a valid import path even when this lab folder name
# contains dashes, e.g. "Day01-lab-assignment-main".
_PATCHABLE_MODULE_NAME = "student_solution"
...
for _function in (
    ...
    _function.__module__ = _PATCHABLE_MODULE_NAME
